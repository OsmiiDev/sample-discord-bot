import {ActionRowBuilder, ContextMenuCommandBuilder, EmbedBuilder, GuildMember, ModalBuilder, ModalSubmitInteraction, PermissionFlagsBits, TextInputBuilder,
  TextInputStyle, UserContextMenuCommandInteraction} from 'discord.js';
import {randomBytes} from 'crypto';
import Ban from '../../modules/moderation/Ban';

/**
 * @description - [Ban] user context command
 */
